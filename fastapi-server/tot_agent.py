...
def create_tot_agent(llm, tools: List[BaseTool], session_project_dir: str = "", on_event: Optional[Callable[[str, str], Awaitable[None]]] = None):
    """
    ...
    4. Feedback: score result quality 1-10
    5. If score > 7 → accept. Else backtrack or replan.
    6. Replan: generate fresh strategies from failed learnings (max 1 replan cycle).
    """
...
Respond in JSON: {{"score": 8, "reasoning": "Brief reasoning"}}"""
    ...
    workflow.add_edge("execute_plan", "feedback")
